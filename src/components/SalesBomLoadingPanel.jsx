      ...
      <Stack alignItems="center" spacing={compact ? 1.35 : 1.7} sx={{ position: 'relative', zIndex: 1 }}>
        <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ width: '100%' }}>
          <Stack direction="row" spacing={0.85} alignItems="center">
            ...
            <Typography sx={{ fontWeight: 950, letterSpacing: '0.035em', color: '#103b5c', fontSize: compact ? '0.92rem' : '1rem' }}>
        ...
        {showFile && file && (
          ...
          >
            ...
            <Box sx={{ minWidth: 0, flex: 1 }}>
              <Typography noWrap sx={{ color: '#103b5c', fontWeight: 850, fontSize: '0.81rem' }}>
