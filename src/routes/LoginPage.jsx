...
import { defaultAuthorizedPath, getAccessibleBuyers, normalizeBuyerKey, setSelectedBuyerKey } from '../utils/buyerContext';
    ...
    try {
      ...
      if (res.status >= 200 && res.status < 300 && token) {
        ...
        if (!isAdminRole(loggedInRole)) {
          ...
          // No Buyer selection popup after login.
          // Use the first accessible Buyer as the initial workspace; users can switch
          // Buyer anytime from the existing Switch Buyer control in the header.
