...
export default function UserPage() {
  ...
  const UserAvatar = () => {
    ...
    const avatarSx = {
      ...
      flexShrink: 0,
      border: `2px solid ${alpha('#3B82F6', 0.78)}`,
      boxShadow: `0 0 0 3px ${alpha('#3B82F6', 0.10)}`,
    ...
    <Box sx={{ flexShrink: 0, ml: 0.75 }}>
      <ButtonBase
        ...
        sx={{
          ...
          '&:hover': { bgcolor: alpha('#3B82F6', 0.07), transform: 'translateY(-1px)' },
          '&:focus-visible': {
            outline: `2px solid ${alpha('#3B82F6', 0.55)}`,
            outlineOffset: 2
          }
        }}
      >
