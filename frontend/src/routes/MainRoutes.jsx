...
const GeneralSettingsPage = Loadable(lazy(() => import('pages/settings/GeneralSettingsPage')));
      ...
      children: [
        {
          ...
          children: [
            ...
            { path: 'settings', element: <AdminRoute><Navigate to="/settings/general" replace /></AdminRoute> },
            { path: 'settings/general', element: <AdminRoute><GeneralSettingsPage /></AdminRoute> },
