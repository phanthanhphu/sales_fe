...
export default function BomTab({ order, buyerKey: buyerKeyProp }) {
  ...
  return (
    <Box>
      ...
      <Box sx={{ px: 0.9, py: 0.55, borderTop: '1px solid #e5e7eb', bgcolor: '#fbfcfe' }}>
        <Typography sx={{ fontSize: '0.75rem', color: '#6b7c90' }}>{filteredRows.length} of {rows.length} BOM(s)</Typography>
      </Box>
